...
public class Main {
        public static void main(String[] args) {
                ...
                String[] options = { "De Reais a Dólares","De Dólares a Reais","De Reais a Euros",
                                "De Euros a Reais","De Reais a Peso Argentino","De Peso Argentino a Reais",
                ...
                while (isContinue) {
                        ...
                        String menu = JOptionPane.showInputDialog(null, "Escolha um opção", "Menu", JOptionPane.DEFAULT_OPTION, null, converter, converter[0]).toString();

                        if (menu.equals("Conversor de moedas")) {

                                String choice = JOptionPane.showInputDialog(null, "Escolha a conversão", "Menu",JOptionPane.QUESTION_MESSAGE,
                                ...
                                try {
                                        ...
                                        if (typeCoins != null) {
                                                ...
                                                JOptionPane.showMessageDialog(null,"Total: $" + df.format(coin) + " " + coinCoverter.substring(1));
                        ...
                        Integer outPut = JOptionPane.showConfirmDialog(null, "Deseja Continuar?", "Menu",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);
